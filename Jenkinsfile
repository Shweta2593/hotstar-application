pipeline{
    ...
    stages {
            ...
            steps{
                script{
                   withDockerRegistry(credentialsId: 'docker', toolName: 'docker'){   
                       ...
                       sh "docker tag hotstar shwetark/hotstar:latest "
                       sh "docker push shwetark/hotstar:latest "
                    }
                }
            }
        }
        stage("TRIVY"){
            steps{
                sh "trivy image shwetark/hotstar:latest > trivyimage.txt" 
            }
        }
    ...
    always {
        script {
            ...
            emailext (
                ...
                """,
                to: 'shwetakanni32@gmail.com',
                from: 'shwetakanni32@gmail.com',
                replyTo: 'shwetakanni32@gmail.com',
                mimeType: 'text/html',
